...
export function ListingsSidebar({ listings, sortOptions = [] }: {
    listings: Listing[],
    sortOptions: {
        value: string;
        label: string;
            ...
            <ScrollArea className="flex-1">
                <div className="p-4 space-y-4">
                    {listings.map((listing) => (
                        <Card key={listing.id} className="overflow-hidden border-none shadow-sm hover:shadow-md transition-shadow cursor-pointer">
