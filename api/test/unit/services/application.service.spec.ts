...
export const mockCreateApplicationData = (
  ...
  return {
    ...
    applicationSelections: multiselectQuestionId
      ? [
          {
...
describe('Testing application service', () => {
  ...
  describe('getDuplicateFlagsForApplication endpoint', () => {
  ...
  describe('buildWhereClause helper function', () => {
  ...
  describe('updateListingApplicationEditTimestamp endpoint', () => {
  ...
  describe('generateConfirmationCode helper function', () => {
  ...
  describe('create endpoint', () => {
    ...
    it('should create an application from public site with MSQV2 enabled', async () => {
      ...
      await service.create(dto, true, requestingUser);
        ...
        data: {
          ...
          selections: {
            createMany: {
              data: [
                {
                  addressHolderAddressId: expect.anything(),
                  multiselectOptionId: expect.anything(),
                },
              ],
            },
          },
          ...
          selections: {
            createMany: {
              data: [
                {
                  addressHolderAddressId: expect.anything(),
                  multiselectOptionId: multiselectOptionId,
                },
              ],
            },
          },
  ...
  describe('mostRecentlyCreated endpoint', () => {
