...
describe('Testing custom feature service', () => {
    ...
    it('testing list()', async () => {
        ...
        prisma.customListingFeatures.findMany = jest.fn().mockResolvedValue(mockedValue);
    ...
    it('testing findOne() with id present', async () => {
        ...
        prisma.customListingFeatures.findUnique = jest.fn().mockResolvedValue(mockedValue);
    ...
    it('testing create()', async () => {
        ...
        prisma.customListingFeatures.create = jest.fn().mockResolvedValue(mockedValue);
    ...
    it('testing delete()', async () => {
        ...
        const mockedValue = mockCustomFeature(date);
        prisma.customListingFeatures.findUnique = jest.fn().mockResolvedValue(mockedValue);
        prisma.customListingFeatures.delete = jest.fn().mockResolvedValue(mockedValue);
    ...
    it('testing findOrThrow() record found', async () => {
        const date = new Date();
        const mockedValue = mockCustomFeature(
            date,
        );
        prisma.customListingFeatures.findUnique = jest.fn().mockResolvedValue(mockedValue);
