...
export class CustomFeatureService {
    ...
    */
    async create(incomingData: CustomListingFeatureCreate): Promise<CustomListingFeature> {
    ...
    */
    async update(incomingData: CustomListingFeatureUpdate): Promise<CustomListingFeature> {
    ...
    */
    async findOrThrow(customListingFeatureId: string): Promise<CustomListingFeatures> {
