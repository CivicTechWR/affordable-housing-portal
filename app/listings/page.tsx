  ...
  const listings = [
    {
      ...
      baths: 2,
      sqft: 100,
      imageUrl: "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=600&h=340&fit=crop",
      timeAgo: "2 days ago",
      lat: 43.4643,
      lng: -80.5204,
    },
  ...
  return (
    <NuqsAdapter>
      <div className="flex h-screen flex-col">
        <Suspense
          fallback={<div className="flex h-16 items-center border-b bg-white px-4 shrink-0" />}
        >
          <SearchHeader />
        </Suspense>
