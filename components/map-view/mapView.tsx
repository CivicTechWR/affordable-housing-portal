    ...
    <div className="relative w-full h-full bg-[#e5e3df] overflow-hidden">
      ...
      <div className="absolute top-4 left-4 flex gap-2 z-10">
        <div className="flex bg-white rounded-md shadow-sm border overflow-hidden">
          <Button variant="ghost" className="rounded-none border-r px-4 h-9 bg-gray-50">Map</Button>
          <Button variant="ghost" className="rounded-none px-4 h-9">Satellite</Button>
        </div>
      ...
      <div className="absolute bottom-8 right-4 flex flex-col gap-1 z-10">
        <Button size="icon" variant="outline" className="bg-white shadow-md rounded-b-none border-b-0 h-10 w-10">
          <HugeiconsIcon icon={Plus} strokeWidth={2} />
        </Button>
        <Button size="icon" variant="outline" className="bg-white shadow-md rounded-t-none h-10 w-10">
