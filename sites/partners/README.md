...
This is the admin/partner portal providing the UI for all administrative functions for affordable housing partners, including managing applications and listings. Partners include housing developers, property managers, cities, and counties. See the [root README](../../README.md) for a full project overview.
...
- If you do not yet have access to the Infisical workspace, ping the appropriate Slack channel (e.g. `#dev-ops` or `#infra`) to request access and the credentials/invite.
